  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-100" dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-grow">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col md:flex-row items-center justify-between mb-10">
        ...
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <motion.section variants={cardVariants} className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200">
          ...
          <motion.aside variants={cardVariants} className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 h-fit">
            <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center">
