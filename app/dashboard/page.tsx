...
// CORRECTION : Importation des types Variants et Transition pour une meilleure conformité TypeScript
...
export default function HomePage() {
  ...
  // CORRECTION : Définition des variantes avec les types explicites
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900 antialiased" dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-grow">
        <section className="relative flex items-center justify-center min-h-[calc(100vh-64px)] overflow-hidden p-6 text-center bg-white">
          ...
          {/* CORRECTION : La prop 'transition' a été retirée car elle est maintenant dans la variante 'fadeIn' */}
